...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder>{
    ...
    public CartListAdapter(Context context, List<Productfile> productList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.single_item_view, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.Add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity) context).AddcartValue("1","Add",productfile);
            }
        });
           ...
           String total=  holder.tv_quantity.getText().toString();
            ...
            if (!(Integer.parseInt(total) ==20)){
               quanitiy=Integer.parseInt(total)+1;
                ...
                ((MainActivity) context).AddcartValue(String.valueOf(quanitiy),"Add", productfile);
            }
        ...
        holder.cart_minus_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Integer.parseInt(total)==1){
                    ...
                    holder.cart_minus_img.setVisibility(View.GONE);
                    holder.cart_plus_img.setVisibility(View.GONE);
                    ((MainActivity) context).AddcartValue(String.valueOf(quanitiy),"minus", productfile);
                }else{
                   quanitiy=Integer.parseInt(total)-1;
                    holder.tv_quantity.setText(String.valueOf(quanitiy));
                    ((MainActivity) context).AddcartValue(String.valueOf(quanitiy),"minus", productfile);
